...
class CredentialSpecDrift(BaseModel):
    ...
    name: str
    type: str
    live_provided_by: Literal["user", "publisher", "template"]
    snapshot_provided_by: Literal["user", "publisher", "template"]
    drifted: bool


class BundleCredentialDrift(BaseModel):
