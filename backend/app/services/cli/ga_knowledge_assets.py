...
# ``sync_ga_knowledge.py`` script without triggering backend Settings
...
# ---------------------------------------------------------------------------
#
# The ``general-assistant-env`` template ships a committed, pre-synced snapshot
...
GA_TEMPLATE_NAME = "general-assistant-env"


def _ga_workspace_dir() -> Path:
    """Absolute path to the GA template's container workspace root."""
