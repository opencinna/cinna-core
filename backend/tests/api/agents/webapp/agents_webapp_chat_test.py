"""
Integration tests: Webapp Chat — Basic chat features.

Covers the core webapp chat session endpoints under /api/v1/webapp/{token}/chat/...:
  ...
  D. Unauthenticated and wrong-token-type access → 401/403
  E. chat_mode "conversation" and "building" produce correctly-typed sessions
