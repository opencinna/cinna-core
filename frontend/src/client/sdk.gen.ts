...
export class AppSyncService {
     ...
     * @throws ApiError
     */
    public static pairingComplete(data: AppSyncPairingCompleteData): CancelablePromise<AppSyncPairingCompleteResponse> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/v1/app-sync/pairing/{code}/complete',
            path: {
                code: data.code
            },
            body: data.requestBody,
