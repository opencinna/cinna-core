...
export class AgentAppMcpRoutesService {
     ...
     * @param data The data for the request.
     * @param data.agentId
     * @returns RouteConflictResponse Successful Response
     * @throws ApiError
     */
    public static checkRouteConflicts(data: AgentAppMcpRoutesCheckRouteConflictsData): CancelablePromise<AgentAppMcpRoutesCheckRouteConflictsResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/agents/{agent_id}/app-mcp-routes/conflicts',
            path: {
                agent_id: data.agentId
            },
            errors: {
