...
export class InternalService {
     ...
     * @throws ApiError
     */
    public static environmentStatusUpdated(data: InternalEnvironmentStatusUpdatedData): CancelablePromise<InternalEnvironmentStatusUpdatedResponse> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/v1/internal/environments/{env_id}/status-updated',
            path: {
                env_id: data.envId
            },
            errors: {
