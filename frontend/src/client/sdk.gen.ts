...
export class SkillsService {
     ...
     *
     * The bytes are the same deterministic archive the container downloads, so a
     * reader can check what they got against the revision's ``content_hash``
