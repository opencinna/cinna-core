...
export class AdminLlmProvidersService {
     ...
     * @param data The data for the request.
     * @param data.managedCredentialId
     * @param data.dryRun Return who would receive the credential without granting it. Backs the confirm dialog's preview count.
     * @returns ManagedAICredentialApplyResult Successful Response
     * @throws ApiError
     */
    public static applyManagedAiCredentialToExisting(data: AdminLlmProvidersApplyManagedAiCredentialToExistingData): CancelablePromise<AdminLlmProvidersApplyManagedAiCredentialToExistingResponse> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/v1/admin/llm-providers/{managed_credential_id}/apply-to-existing',
            path: {
                managed_credential_id: data.managedCredentialId
            },
            query: {
     ...
     * @throws ApiError
     */
    public static retryMemberKeyProvisioning(data: AdminLlmProvidersRetryMemberKeyProvisioningData): CancelablePromise<AdminLlmProvidersRetryMemberKeyProvisioningResponse> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/v1/admin/llm-providers/{managed_credential_id}/members/{user_id}/retry',
            path: {
                managed_credential_id: data.managedCredentialId,
                user_id: data.userId
            },
...
export class AdminProviderAdaptersService {
    /**
     ...
     * @throws ApiError
     */
    public static listProviderAdapters(): CancelablePromise<AdminProviderAdaptersListProviderAdaptersResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/admin/provider-adapters/'
        });
    }
}
...
export class AdminProviderCredentialsService {
     ...
     * @returns ProviderAdminCredentialPublic Successful Response
     * @throws ApiError
     */
    public static listProviderAdminCredentials(): CancelablePromise<AdminProviderCredentialsListProviderAdminCredentialsResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/admin/provider-admin-credentials/'
        });
    }
     ...
     * @throws ApiError
     */
    public static createProviderAdminCredential(data: AdminProviderCredentialsCreateProviderAdminCredentialData): CancelablePromise<AdminProviderCredentialsCreateProviderAdminCredentialResponse> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/v1/admin/provider-admin-credentials/',
            body: data.requestBody,
     ...
     * @throws ApiError
     */
    public static getProviderAdminCredential(data: AdminProviderCredentialsGetProviderAdminCredentialData): CancelablePromise<AdminProviderCredentialsGetProviderAdminCredentialResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/admin/provider-admin-credentials/{credential_id}',
            path: {
     ...
     * @throws ApiError
     */
    public static updateProviderAdminCredential(data: AdminProviderCredentialsUpdateProviderAdminCredentialData): CancelablePromise<AdminProviderCredentialsUpdateProviderAdminCredentialResponse> {
        return __request(OpenAPI, {
            method: 'PATCH',
            url: '/api/v1/admin/provider-admin-credentials/{credential_id}',
            path: {
     ...
     * @throws ApiError
     */
    public static deleteProviderAdminCredential(data: AdminProviderCredentialsDeleteProviderAdminCredentialData): CancelablePromise<AdminProviderCredentialsDeleteProviderAdminCredentialResponse> {
        return __request(OpenAPI, {
            method: 'DELETE',
            url: '/api/v1/admin/provider-admin-credentials/{credential_id}',
            path: {
     ...
     * @param data The data for the request.
     * @param data.credentialId
     * @returns ProviderAdminCredentialVerifyResult Successful Response
     * @throws ApiError
     */
    public static verifyProviderAdminCredential(data: AdminProviderCredentialsVerifyProviderAdminCredentialData): CancelablePromise<AdminProviderCredentialsVerifyProviderAdminCredentialResponse> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/v1/admin/provider-admin-credentials/{credential_id}/verify',
            path: {
                credential_id: data.credentialId
            },
            errors: {
     ...
     * @throws ApiError
     */
    public static applyProviderSpendLimit(data: AdminProviderCredentialsApplyProviderSpendLimitData): CancelablePromise<AdminProviderCredentialsApplyProviderSpendLimitResponse> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/v1/admin/provider-admin-credentials/{credential_id}/apply-spend-limit',
            path: {
                credential_id: data.credentialId
            },
            errors: {
