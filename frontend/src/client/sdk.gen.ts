...
export class AdminLlmProvidersService {
     ...
     * @param data The data for the request.
     * @param data.requestBody
     * @returns AdminAICredentialProvisionResult Successful Response
     * @throws ApiError
     */
    public static provisionAiCredentials(data: AdminLlmProvidersProvisionAiCredentialsData): CancelablePromise<AdminLlmProvidersProvisionAiCredentialsResponse> {
        return __request(OpenAPI, {
            method: 'POST',
     ...
     * target user.
     * @param data The data for the request.
     * @param data.targetUserId Optional filter to a single target user
     * @returns AdminAICredentialPublic Successful Response
     * @throws ApiError
     */
    ...
    public static getManagedAiCredential(data: AdminLlmProvidersGetManagedAiCredentialData): CancelablePromise<AdminLlmProvidersGetManagedAiCredentialResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/admin/llm-providers/{credential_id}',
            path: {
    ...
    public static setManagedAiCredentialDefault(data: AdminLlmProvidersSetManagedAiCredentialDefaultData): CancelablePromise<AdminLlmProvidersSetManagedAiCredentialDefaultResponse> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/v1/admin/llm-providers/{credential_id}/set-default',
            path: {
                credential_id: data.credentialId
            },
            errors: {
